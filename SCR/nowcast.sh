...
/ment_arch/pscheff/miniconda3-py3.8/envs/panelification_web/bin/python main.py \
  ...
  -s ${rundate1} \
  -d 1 \
  --custom_experiment_file custom_experiments_geosphere \
  --custom_experiments 'arome' 'aromeesuite' 'claef-control' 'claef-mean' 'claef-median' 'claef1k-control' 'claef1k-esuite' 'claef1k-enVar' 'claef1k-mean' 'claef1k-median' 'aromeruc' 'cosmo1e' 'icond2' 'samos' \
