...
/ment_arch/pscheff/miniconda3-py3.8/envs/panelification_web/bin/python main.py -n nowcasting --region Austria -s ${rundate3} -d 1 -l 8 17 8 17  8 17 8 17 8 17 8 17 8 17 8 17 2 5 8 14 8 14 5 11 --custom_experiment_file custom_experiments_geosphere --custom_experiments 'arome' 'aromeesuite' 'claef-control' 'claef-mean' 'claef-median' 'claef1k-control' 'claef1k-mean' 'claef1k-median' 'aromeruc' 'cosmo1e' 'icond2' 'samos' --draw --fix_nans --rank_score_time_series bias mae corr fss_condensed_weighted  
/ment_arch/pscheff/miniconda3-py3.8/envs/panelification_web/bin/python main.py -n nowcasting --region Austria -s ${rundate4} -d 1 -l 9 18 9 18  9 18 9 18 9 18 9 18 9 18 9 18 3 6 9 15 9 15 6 12 --custom_experiment_file custom_experiments_geosphere --custom_experiments 'arome' 'aromeesuite' 'claef-control' 'claef-mean' 'claef-median' 'claef1k-control' 'claef1k-mean' 'claef1k-median' 'aromeruc' 'cosmo1e' 'icond2' 'samos' --draw --fix_nans --rank_score_time_series bias mae corr fss_condensed_weighted  
